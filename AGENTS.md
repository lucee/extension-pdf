...
- **cfdocument**: [Flying Saucer](https://github.com/flyingsaucerproject/flyingsaucer) (HTML/CSS rendering) + [OpenPDF](https://github.com/LibrePDF/OpenPDF) (PDF output)
- **cfpdf**: [Apache PDFBox](https://pdfbox.apache.org/)
