    ...
    function run( testResults, testBox ) {
        describe("Testcase for LDEV-3781", function() {
            ...
            it( title="LDEV-1500, cfdocument with orientation and bookmark attribute", body=function( currentSpec ) {
                document format="pdf" orientation="portrait" bookmark="true" htmlbookmark="true" name="test1500" {
                ...
                reader = createObject("java", "com.lowagie.text.pdf.PdfReader").init(test1500);
                bookmarks = createObject("java","com.lowagie.text.pdf.SimpleBookmark").getBookmark(reader);
