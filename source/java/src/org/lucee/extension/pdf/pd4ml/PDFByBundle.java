...
public class PDFByBundle {
	...
	public PDFByBundle(Config config) throws PageException {
		...
		try {
			...
			if(pd4mlClass == null)
				pd4mlClass = util.loadClassByBundle("org.zefer.pd4ml.PD4ML", "org.zefer", "3.5.0.b1", null);
	...
	/*
	 * private void setEvaluationFooterX() throws PageException { if(isEvaluation) invoke(pd4ml,"setPageFooter",toPD4PageMark(new PDFPageMark(-1,EVAL_TEXT))); }
	 */
	...
	private Object toPD4PageMark(PDFPageMark mark) throws PageException {
		...
		try {
			...
			if(pd4mlMarkClass == null)
				pd4mlMarkClass = util.loadClass(classLoader, "org.zefer.pd4ml.PD4PageMark");
	...
	/*
	 * private void invoke(Object o,String methodName, Object argument1, Object argument2,Class clazz) throws PageException { try {
	 * o.getClass().getMethod(methodName, new Class[]{argument1.getClass(),clazz}).invoke(o, new Object[]{argument1,argument2}); } catch (Exception e) { throw
